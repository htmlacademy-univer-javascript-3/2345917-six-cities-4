import CityCardsList from '../../offer-list/offer-list';
        ...
        <div className="cities">
          <div className="cities__places-container container">
            <section className="cities__places places">
              ...
              <CityCardsList offers={cityOffers} listType={'default'}/>
            </section>
            <div className="cities__right-section">
              <section className="cities__map map"><Map offers={cityOffers} city={city} selectedPoint={undefined}/></section>
            </div>
          </div>
        </div>
      </main>
